      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/flowArrowSymbol-backdrop.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1.75</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/boundaryMereingChangeSymbol-backdrop.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>2</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/benchMarkSymbol-backdrop.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>3</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/railwaySwitchSymbol-backdrop.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>0.5</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/roadFlowSymbol-backdrop.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>1.75</Size>
              <Rotation>-
