...
<qgis version="2.12.0-Lyon" minimumScale="0" maximumScale="4000" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="style_code" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="false" symbol="0" value="1" label="Polygon Closing Line"/>
      <category render="true" symbol="1" value="2" label="Property Closing Line"/>
      <category render="true" symbol="2" value="3" label="Bottom Of Slope"/>
      <category render="true" symbol="3" value="4" label="Top Of Slope"/>
      ...
      <category render="true" symbol="8" value="9" label="Bottom Of Cliff"/>
      <category render="true" symbol="9" value="10" label="Top Of Cliff"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="10">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="0,204,255,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="12">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="3;1.25"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MapUnit"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="204,153,102,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.45"/>
          <prop k="line_width_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="30">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="208,104,0,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.4"/>
          <prop k="line_width_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
