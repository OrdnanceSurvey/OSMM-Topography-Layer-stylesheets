...
<qgis version="2.16.1-Nødebo" simplifyAlgorithm="0" minimumScale="1" maximumScale="4000" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="accuracyofheightabovedatum">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="referencetofeature">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="style_code" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="1" label="Spot Height"/>
      <category render="true" symbol="1" value="2" label="Emergency Telephone"/>
      <category render="true" symbol="2" value="3" label="Site Of Heritage"/>
      <category render="false" symbol="3" value="4" label="Culvert"/>
      <category render="true" symbol="4" value="5" label="Positioned Nonconiferous Tree"/>
      <category render="true" symbol="5" value="6" label="Inland Water"/>
      <category render="true" symbol="6" value="7" label="Roadside"/>
      <category render="true" symbol="7" value="8" label="Overhead Construction"/>
      <category render="true" symbol="8" value="9" label="Rail"/>
      <category render="true" symbol="9" value="10" label="Positioned Coniferous Tree"/>
      <category render="true" symbol="10" value="11" label="Boundary Post Or Stone"/>
      <category render="true" symbol="11" value="12" label="Triangulation Point Or Pillar"/>
      <category render="true" symbol="12" value="13" label="Historic Interest"/>
      <category render="true" symbol="13" value="14" label="Landform"/>
      <category render="true" symbol="14" value="15" label="Tidal Water"/>
      <category render="true" symbol="15" value="16" label="Structure"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="outline_color" v="193,188,176,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="1">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,158,139,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="amenity/amenity_telephone.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="10">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,152,255,255"/>
          <prop k="outline_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="11">
        <layer pass="0" class="FontMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="chr" v="W"/>
          <prop k="color" v="139,157,169,255"/>
          <prop k="font" v="OSMasterMap"/>
          <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="13">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="186,186,186,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.4"/>
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MapUnit"/>
