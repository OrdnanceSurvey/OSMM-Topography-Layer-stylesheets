      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/heritageSiteOfSymbol-bw.svg"/>
      ...
      <!--<FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/culvertSymbol-bw.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>3</Size>
              <Rotation>-
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/positionedNonconiferousTreeSymbol-bw.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>8</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/positionedConiferousTreeSymbol-bw.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>8</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="osmmsymbols/boundaryPostSymbol-bw.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>6</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="osmmsymbols/triangulationStationSymbol-bw.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>4</Size>
            </Graphic>
