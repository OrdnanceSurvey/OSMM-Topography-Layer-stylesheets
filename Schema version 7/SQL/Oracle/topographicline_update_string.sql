...
CASE
	WHEN INSTR(descriptivegroup,  'General Feature') > 0 AND descriptiveterm IS NULL AND physicalpresence = 'Obstructing' THEN 'Default Line'
	WHEN INSTR(descriptivegroup,  'Building') > 0 AND descriptiveterm = 'Outline' AND make = 'Manmade' AND physicalpresence = 'Obstructing' THEN 'Building Outline Line'
	WHEN INSTR(descriptivegroup,  'General Feature') > 0 AND descriptiveterm IS NULL AND physicalpresence = 'Edge / Limit' THEN 'Edge Line'
	WHEN INSTR(descriptivegroup,  'Road Or Track') > 0 AND descriptiveterm = 'Public' AND make = 'Manmade' AND physicalpresence = 'Edge / Limit' THEN 'Road Or Track Line'
	WHEN INSTR(descriptivegroup,  'Building') > 0 AND descriptiveterm = 'Division' AND make = 'Manmade' AND physicalpresence = 'Obstructing' THEN 'Building Division Line'
	WHEN descriptiveterm = 'Polygon Closing Link' THEN 'Polygon Closing Line'
	WHEN INSTR(descriptivegroup,  'Inland Water') > 0 AND descriptiveterm IS NULL AND physicalpresence = 'Edge / Limit' THEN 'Inland Water Line'
	WHEN descriptiveterm = 'Inferred Property Closing Link' THEN 'Property Closing Line'
	WHEN INSTR(descriptivegroup,  'General Surface') > 0 AND descriptiveterm IS NULL AND make = 'Natural' AND physicalpresence = 'Edge / Limit' THEN 'General Surface Natural Line'
	WHEN INSTR(descriptivegroup,  'Building') > 0 AND descriptiveterm = 'Outline' AND make = 'Manmade' AND physicalpresence = 'Overhead' THEN 'Building Overhead Line'
...
style_code =
CASE
	WHEN INSTR(descriptivegroup,  'General Feature') > 0 AND descriptiveterm IS NULL  AND physicalpresence = 'Obstructing' THEN 1
	WHEN INSTR(descriptivegroup,  'Building') > 0 AND descriptiveterm = 'Outline' AND make = 'Manmade' AND physicalpresence = 'Obstructing' THEN 2
	WHEN INSTR(descriptivegroup,  'General Feature') > 0 AND descriptiveterm IS NULL AND physicalpresence = 'Edge / Limit' THEN 3
	WHEN INSTR(descriptivegroup,  'Road Or Track') > 0 AND descriptiveterm = 'Public' AND make = 'Manmade' AND physicalpresence = 'Edge / Limit' THEN 4
	WHEN INSTR(descriptivegroup,  'Building') > 0 AND descriptiveterm = 'Division' AND make = 'Manmade' AND physicalpresence = 'Obstructing' THEN 5
	WHEN descriptiveterm = 'Polygon Closing Link' THEN 6
	WHEN INSTR(descriptivegroup,  'Inland Water') > 0 AND descriptiveterm IS NULL AND physicalpresence = 'Edge / Limit' THEN 7
	WHEN descriptiveterm = 'Inferred Property Closing Link' THEN 8
	WHEN INSTR(descriptivegroup,  'General Surface') > 0 AND descriptiveterm IS NULL AND make = 'Natural' AND physicalpresence = 'Edge / Limit' THEN 9
	WHEN INSTR(descriptivegroup,  'Building') > 0 AND descriptiveterm = 'Outline' AND make = 'Manmade' AND physicalpresence = 'Overhead' THEN 10
