...
xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd">
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="osmmsymbols/spotHeightSymbol.svg"/>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/positionedNonconiferousTreeSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>8</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/positionedConiferousTreeSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>8</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="osmmsymbols/boundaryPostSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>6</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:type="simple" xlink:href="osmmsymbols/triangulationStationSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>4</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/heritageSiteOfSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>4.5</Size>
            </Graphic>
      ...
      <FeatureTypeStyle>
        <Rule>
          ...
          <PointSymbolizer uom="http://www.opengeospatial.org/se/units/metre">
            <Graphic>
              <ExternalGraphic>
                <OnlineResource xlink:href="osmmsymbols/positionedBoulderSymbol.svg"/>
                <Format>image/svg+xml</Format>
              </ExternalGraphic>
              <Size>6</Size>
            </Graphic>
      ...
      <!-- Disused Feature Point -->
      <FeatureTypeStyle>
        <Rule>
          <Name>Disused Feature Point</Name>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>style_code</ogc:PropertyName>
